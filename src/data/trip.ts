...
export const flights: FlightLeg[] = [
  ...
  {
    id: "wife-manu-ord-sjd",
    passenger: "Wife & Manuela",
    date: "Fri 19 Jun 2026",
    from: "Chicago O'Hare",
    fromCode: "ORD",
    to: "San José del Cabo",
    toCode: "SJD",
    airline: "TODO — paste airline + flight #",
    flightNumber: "TODO",
    departure: "01:40",
    arrival: "10:09",
    status: "booked",
    note: "Wife and Manuela fly together from Chicago. Meet Julian at SJD around lunchtime on 19 Jun.",
  },
  {
...
export const groundLegs: GroundLeg[] = [
  ...
  },
  {
    ...
    from: "Loreto",
    to: "San José del Cabo",
    duration: "1h30 flight (no bus — too slow)",
    passenger: "Manuela",
    note: "Bus is out — arrives SJD ~13:00, after Manu's 11:52 SJD → ORD departure. Book a Calafia/Aeromar LTO → SJD short hop on 26 or early 27 Jun, or fly Loreto → SJD via La Paz.",
    status: "to book",
  },
  {
    id: "loreto-bahia",
...
export const stays: Stay[] = [
  ...
  },
  {
    ...
    travelOut: "27 June split: Manuela flies LTO → SJD (connector) then SJD → ORD 11:52. Julian + wife drive north to Bahía Concepción.",
    links: [
...
export const itineraryItems: ItineraryItem[] = [
  ...
  },
  {
    ...
    type: "flight",
    status: "booked",
    time: "Julian VB1212 06:10–07:15; Wife & Manu ORD 01:40 → SJD 10:09",
    bookedWith: "VivaAerobus + ORD → SJD direct",
  ...
  },
  {
    date: "27 Jun 2026",
    day: "Sat",
    title: "Manuela: LTO → SJD connector + 11:52 flight home",
    place: "Loreto → SJD → ORD",
    type: "flight",
    status: "to book",
    time: "Manu SJD 11:52 → ORD",
    note: "⚠ Bus won't make it. Book Manu a Calafia/Aeromar LTO → SJD on 26 Jun afternoon (with SJD airport hotel) or very early 27 Jun.",
  },
  {
    date: "27 Jun 2026",
    day: "Sat",
